...
class Commission(Base):
    ...
    percentage = Column(Float, nullable=False)  # Commission percentage (e.g. 10.0 for 10%)
    rate = Column(Float, nullable=False)  # Commission rate as decimal (e.g. 0.10 for 10%)
    amount_cents = Column(Integer, nullable=False)
